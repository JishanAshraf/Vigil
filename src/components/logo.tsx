            ...
            >
                <defs>
                    <linearGradient id="building-gradient" x1="0%" y1="0%" x2="0%" y2="100%">
                        ...
                        <stop offset="100%" stopColor="#A0E9FF" stopOpacity="0" />
                    </linearGradient>
                    <linearGradient id="line-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" stopColor="#87C5F2" />
                ...
                <path d="M10 20 A 20 20 0 0 1 50 20" fill="none" stroke="#87C5F2" strokeWidth="1.5" />
                <circle cx="12" cy="25" r="4" fill="#87C5F2" />
                <path d="M12 29 L12 35" stroke="#87C5F2" strokeWidth="1.5" />
                <circle cx="17" cy="20" r="5" fill="#A0E9FF" />
                <path d="M17 25 L17 35" stroke="#A0E9FF" strokeWidth="1.5" />
                <text
                    x="60"
                    y="30"
